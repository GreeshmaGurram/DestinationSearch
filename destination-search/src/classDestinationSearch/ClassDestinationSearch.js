...
import "./ClassDestinationSearch.css"

class ClassDestinationSearch extends Component{
      ...
      const {searchInput} = this.state
        return(
            <div className='search-bar-container'>
                <SearchBar getSearchInputValue={this.getSearchInputValue}/>
                <SearchResults destinationsList={this.destinationsList} searchInput={searchInput}/>
            </div>
        );
    }
}

export default ClassDestinationSearch