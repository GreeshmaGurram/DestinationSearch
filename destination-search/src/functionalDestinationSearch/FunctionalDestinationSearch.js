...
import "../classDestinationSearch/ClassDestinationSearch.css"
import SearchBar from "../SearchBar/SearchBar";
import SearchResults from "../SearchResults/SearchResults";

function FunctionalDestinationSearch(){
    const destinationsList = [
      ...
      const getSearchInputValue = (newValue) => {
    ...
    return(
        <div className="search-bar-container">
            ...
            <SearchResults destinationsList={destinationsList} searchInput={searchInput}/>
        </div>
    );
}

export default FunctionalDestinationSearch;